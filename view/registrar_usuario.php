...
<div class="container">
 ...
 if (isset($_REQUEST['error'])) {
   echo"<center><div class='alert alert-danger'>ha ocurrido un error vuelve a intentarlo</div></center><br>";
 }
 ?>
			...
			<div class="card-body">
				<form action="../php/registrar_usuarios.php" method="POST">
					...
					<br>
						<input type="submit" value="Registrarme" class="btn btn-warning btn btn-block">
